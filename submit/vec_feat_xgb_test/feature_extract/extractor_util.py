...
def extract_word_align_feature(sent_1, sent_2, type="word"):
    ...
    for index_1, word_1 in enumerate(sent_1):
        for index_2, word_2 in enumerate(sent_2):
            ...
            distance_matrix[index_1, index_2] = editdistance.eval(word_1, word_2)
    ...
    align_feature["sequeence_levendistance_%s" % type] = editdistance.eval(sent_1, sent_2)
    align_feature["sequeence_levendistance_character"] = editdistance.eval("".join(sent_1), "".join(sent_2))
